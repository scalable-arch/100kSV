...
struct iptmpl {
    QIRD  * I721;
    struct vcs_globals_t * I722;
    void * I724;
    UP  I725;
    UP  I726;
    struct iptmpl * I717[2];
};
...
typedef struct _RmaMultiInputTable {
    ...
    UB  * I889;
    UB  * I890;
    struct _RmaMultiInputTable * I865;
...
typedef struct {
    U  I702;
    U  I710;
    RmaThreadSchedCompiledLoads  * I993;
...
typedef struct {
    ...
    RP   I798[(4)];
    RP   I800[(4)];
    RemoteDbsedLoad   I1052[1];
} RmaRtlEdgeBlock;
typedef struct TableAssign_ {
    struct TableAssign_ * I865;
    struct TableAssign_ * I785;
    U  I5;
    U  I1054 :1;
    U  I1055 :1;
    U  I1056 :2;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I865;
    struct TableAssignLayoutOnClk_ * I785;
    U  I5;
    U  I1054 :1;
    U  I1055 :1;
    U  I1056 :2;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I865;
    struct TableAssignLayoutOnClkOpt_ * I785;
    U  I5;
    U  I1054 :1;
    U  I1055 :1;
    U  I1056 :2;
    ...
    U  I367 :15;
    U  I1066;
    RmaSeqPrimOutputOnClkOpt  I1063;
    RmaSeqPrimOutputEblkData  I1067;
...
typedef struct RmaNonEdgeLoadHdr1_ {
    UB  I1123;
    UB  I1131;
    RmaNonEdgeLoadData1  * I1039;
    RmaNonEdgeLoadData1  * I785;
    void * I1132;
} RmaNonEdgeLoadHdr1;
...
typedef struct RmaChildClockPropList1_ {
    RmaChildClockProp  * I1039;
    RmaChildClockProp  * I785;
...
struct futq_slot1 {
    U  I742;
    struct futq_slot2  I743[32];
};
struct futq_info {
    scalar  * I737;
    U  I738;
    U  I739;
    struct futq_slot1  I740[32];
};
struct futq {
    struct futq * I727;
    struct futq * I729;
...
struct dummyq_struct {
    ...
    struct futq * I1149;
    struct futq * I1150;
    struct sched_table * I1151;
    struct futq_info * I1153;
    ...
    int I1216;
    int I1217;
    struct vcs_globals_t * I1218;
    clock_struct  I1219;
    unsigned long long I1220;
    EBLK  * I1221;
    EBLK  * I1222;
    void * I1223;
};
